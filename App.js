...
export default function App() {
  return (
    <ScrollView style={styles.container}>
      <StatusBar style="light" backgroundColor="#43A047" />
      
      <View style={styles.header}>
        <Text style={styles.title}>Food Connect</Text>
        <Text style={styles.subtitle}>A platform for culinary professionals to network, find jobs, and collaborate</Text>
      </View>
      ...
      <View style={styles.content}>
        ...
        <TouchableOpacity style={[styles.button, {backgroundColor: '#43A047'}]}>
